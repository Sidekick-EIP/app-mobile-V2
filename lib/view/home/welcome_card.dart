            ...
            children: <Widget>[
              Padding(
                ...
                child: Text('Bienvenue !',
                    textAlign: TextAlign.left, style: pSemiBold20),
              ),
              Row(
...
class WelcomeCardWSidekick extends StatelessWidget {
  ...
  const WelcomeCardWSidekick(
      {super.key, required this.sidekickName, required this.imagePath});
  ...
  Widget build(BuildContext context) {
    return Container(
        ...
        decoration: BoxDecoration(
          borderRadius: BorderRadius.circular(7.7),
          boxShadow: const [
            BoxShadow(color: Color.fromRGBO(242, 93, 41, 0.5), blurRadius: 16),
          ],
          ...
          Expanded(
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  Text(
                    '$sidekickName vient de réaliser sa séance d’abdos il y a 3h !',
